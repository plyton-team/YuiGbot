...
import YuiGBot.modules.sql.notes_sql as sql
from YuiGBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from YuiGBot.__main__ import DATA_IMPORT
...
# from YuiGBot.modules.rules import get_rules
import YuiGBot.modules.sql.rules_sql as rulessql

# from YuiGBot.modules.sql import warns_sql as warnssql
import YuiGBot.modules.sql.blacklist_sql as blacklistsql
from YuiGBot.modules.sql import disable_sql as disabledsql

# from YuiGBot.modules.sql import cust_filters_sql as filtersql
# import YuiGBot.modules.sql.welcome_sql as welcsql
import YuiGBot.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    with open("YuiGBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("YuiGBot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `YuiGBot-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("YuiGBot{}.backup".format(chat_id))  # Cleaning file
